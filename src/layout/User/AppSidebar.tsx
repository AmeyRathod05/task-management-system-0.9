...
const AppSidebar: React.FC = () => {
          ...
          {nav.subItems ? (
            ...
            >
              ...
              {(isExpanded || isHovered || isMobileOpen) && (
                <span className={`menu-item-text text-gray-400`}>{nav.name}</span>
              )}
              {(isExpanded || isHovered || isMobileOpen) && (
                <ChevronDownIcon
  ...
  return (
    <aside
      className={`fixed mt-16 flex flex-col lg:mt-0 top-0 px-5 left-0 bg-black dark:bg-gray-900 dark:border-gray-800 text-gray-900 h-full transition-all duration-300 ease-in-out z-50 border-r border-gray-200 
        ${
