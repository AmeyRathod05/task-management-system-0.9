...
const Notification: React.FC<NotificationProps> = ({
  ...
  title,
  description,
  hideDuration = 3000, // Auto-hide after 3 seconds
}) => {
  ...
  return (
    <div
      className={`bg-white fixed top-[90px] right-4 z-[9999] flex items-center justify-between gap-3 w-full sm:max-w-[340px] rounded-md border-b-4 p-3 shadow-theme-sm dark:bg-[#1E2634] transition-transform duration-300 ease-in-out transform ${
        isMounted ? 'translate-x-0' : 'translate-x-[120%]'
      } ${borderColor}`}
      style={{ zIndex: 9999 }}
      role="alert"
      aria-live="assertive"
